...
<form method="post" action="Assets\Lib\PHPFunctions\UpdateProfilAt.php?BrukerID=<?= $ArbeidsInfo['BrukerID']?>">
        ...
        <label for="Navn"><strong>Navn:</strong></label><br>
        <input type="text" name="Navn" value="<?php echo $ArbeidsInfo['Navn']; ?>" required><br> 

        <label for="epost"><strong>Epost:</strong></label><br>
        <input type="text" name="Epost" value="<?php echo $ArbeidsInfo['Epost']; ?>" required><br> 
...
<a href="http://localhost/Jobbsystem/www/Pages/Profilside/ProfilAt.php">
